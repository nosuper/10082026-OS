...
//
// Same reasoning as the Vue suite next door: this runs inside the official
// Playwright image as root with the repo bind-mounted, so anything written
// under the repo lands on the host owned by root and the host user cannot
